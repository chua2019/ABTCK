function [site,Zt,site_real, Zt_real, n, prCurr1,AA, a, lim_ALL,NODES,a_NODES]=...
    Merge_NON_nest(prCurr,site,Zt,site_real, Zt_real,n,AA,S,lim_ALL,a,a_NODES,NODES, aalpha, bbeta,tau1,tau2,funname)
...
X_s{k_new}=mean_basisMulti(site_new1{k_new},Zt_new1{k_new},S);
for t=1:S
[mu_Zt11, SIGMA11, beta_X11, prProp11{t}]=Multi_mu_s3(Zt_new1{k_new}{t},AA_new1{k_new}{t}, site_new1{k_new}{t},X_s{k_new}{t},tau1,tau2);
...
for t=1:S
 ...
 prod_prProp=prod_prProp+prProp{k_new}{t};
  ...
  MH_ratio = (prod_prProp+0-prod_prCurr1-prod_prCurr2)+5*(Prior_prop-Prior_curr)+(log(P)-log(G));
u = log(rand);%0;%
%MH_ratio-u
if (u<MH_ratio)
% accept
